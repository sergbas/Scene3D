...
public class LangParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LangParserVisitor<T> {
	 ...
	 */
	@Override public T visitSceneDeclaration(LangParser.SceneDeclarationContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitSceneName(LangParser.SceneNameContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitObject3d(LangParser.Object3dContext ctx) { return visitChildren(ctx); }
}